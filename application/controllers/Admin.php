...
class Admin extends CI_Controller {
    ...
    public function monitoring()
    {
        ...
        $data['notifikasi_admin'] = $this->Grup_model->get_unread_notifications($admin_id);
    ...
    public function notifications()
    {
        ...
        // Tandai sudah dibaca dan ambil semua notifikasi
        $this->db->where('user_id_tujuan', $admin_id)->update('tabel_notifikasi', ['is_read' => TRUE]);

        $this->db->select('n.*, g.nama_grup, gi.deskripsi');
